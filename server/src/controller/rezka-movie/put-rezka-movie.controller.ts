...
app.put(API_URL.api.rezka_movie.id().toString(), async (req: IRequest, res: IResponse) => {
...
export const putRezkaMovieAsync = async (id: string, data: Omit<Partial<RezkaMovieDto>, 'id'>) => {
