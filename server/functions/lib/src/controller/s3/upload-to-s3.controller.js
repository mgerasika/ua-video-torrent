...
const uploadFileToAmazonAsync = async ({ hurtomDownloadId, }) => {
    return (0, to_promise_util_1.toPromise)(() => axios_1.default.get(`https://toloka.to/download.php?id=${hurtomDownloadId}`, get_hurtom_all_controller_1.HURTOM_HEADERS).then((response) => {
